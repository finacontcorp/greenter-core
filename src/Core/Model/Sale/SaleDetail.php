...
use Greenter\Model\Sale\DetractionTransport;
...
class SaleDetail
{
  ...
  /**
   * @var DetractionTransport
   */
  protected $detractionTransport;
  ...
  /**
   * @return DetractionTransport
   */
  public function getDetractionTransport()
  {
    return $this->detractionTransport;
  }

  /**
   * @param DetractionTransport $detractionTransport
   *
   * @return $this
   */
  public function setDetractionTransport($detractionTransport)
  {
    $this->detractionTransport = $detractionTransport;
